...
버전: 0.2 · 갱신일: 2026-09-20 · 상태: 최종기획서 정합화
...
- TransactionWindow: start_at, end_at, transaction_count, completeness (고정 12개월을 전제하지 않는 최근 거래 범위)
- LeakageCandidate: type (UNUSED_SUBSCRIPTION/REVOLVING_INTEREST/OTHER), evidence_transaction_ids, estimated_monthly_cost, confidence, review_status
